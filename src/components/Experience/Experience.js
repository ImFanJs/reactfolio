  ...
  render () {
    return (
      <div className='Experience'>
        ...
        <hr />
        <div>
          <p className='company'><i className='fa fa-building' /> Jesco Marketing Monterrey N.L | 2012 - Actual</p>
          <p className='texto'>
          ...
          <p className='texto'>
            Desarrollo mediante React y Angular en base a componentes, utilizando html5, css3, jquery, bootstrap, foundation, javascript es6, entre otras.
          </p>
          <p className='texto'>
            También tengo algo de experiencia en desarrollo móvil utilizando tecnologías como react native y ionic.
          </p>
          <p className='texto'>
